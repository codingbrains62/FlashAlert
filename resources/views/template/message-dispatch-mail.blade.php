        ...
        <tr>
            <td align="center" style="padding:0;">
                <table role="presentation"
                    ...
                    <tr>
                        <td style="padding:30px 25px 25px;background: #fbfbfb;">
                            <table role="presentation"
                    ...
                    <tr style="text-align:center;background: #e4e5eb;"><p style="letter-spacing: 0.8px;font-weight: bold;font-family: 'Roboto';color: #9b381b;font-size: 16px;margin: 8px 0;">© Flash Alert </p></tr>
                </table>
            </td>
        </tr>
    </table>
