                                ...
                                <tr>
                                    <td style="padding:0 0 3px 0;color:#153643;">
                                        ...
                                        <p
                                            ...
                                            You have received a new contact form submission from {{ $user ? $user['name'] : '' }} via flashalert. Below are the details:.
                                        </p>
                                        <strong>Sender's Information:*</strong>
                                        {{-- <p>Name: {{ $user ? $user['name'] : '' }}</p> --}}
                                        {{-- <p>Email: {{ $user ? $user['email'] : '' }}</p> --}}
                                        {{-- <p>Decription: {{ $user ? $user['description'] : '' }}</p> --}}
                                        <p
                                        ...
                                        <p
                                            style="margin:10px 0 12px 0;font-size:13px;font-weight: 600;line-height:24px;font-family:Arial,sans-serif;">
                                            <strong> Email Address: </strong> {{ $user ? $user['email'] : '' }},
                                        </p>
                                        <p style="margin:10px 0 12px 0;font-size:13px;font-weight: 600;line-height:24px;font-family:Arial,sans-serif;">
