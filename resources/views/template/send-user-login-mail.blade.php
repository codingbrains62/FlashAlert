                            ...
                            <table role="presentation"
                                ...
                                <tr>
                                    <td style="padding:0 0 36px 0;color:#153643;">
                                        <p>Welcome to FlashAlert Newswire. Your premium-tier account has been activated and is available for you to post emergency information and news releases.</p>
                                        ...
                                        <p
                                            style="margin:0 0 12px 0;font-size:14px;line-height:24px;font-family:Arial,sans-serif;">
                                           This is Your Organization Name: <b>{{ $user ? $user['name'] : '' }}</b>
                                        </p>
                                        <p
                                            style="margin:0 0 12px 0;font-size:14px;line-height:24px;font-family:Arial,sans-serif;">
                                           This is Your Username: <b>{{ $user ? $user['username'] : '' }}</b> 
                                        </p>
                                        <p
                                            style="margin:0 0 12px 0;font-size:14px;line-height:24px;font-family:Arial,sans-serif;">
