                    ...
                    <div id="main-core">
                                    ...
                                    <tr>
                                        <td class="loginColor">
                                            ...
                                            @else
                                                ...
                                                <a href="https://flashalert.projects-codingbrains.com/IIN/login"
                                                    target="_blank" rel="noopener noreferrer" class="fw-6">Log In</a>
                                            @endif
                                        </td>
                                        <td><a href="http://www.flashalertportland.net/closures-cats.html" target="_blank"
                                                rel="noopener noreferrer"><i
                                                    class="fa-regular fa-clipboard fa-2xl"></i></a><br><a class="fw-6"
                                                href="http://www.flashalertportland.net/closures-cats.html" target="_blank"
                                                rel="noopener noreferrer">View Current Info</a>
                                        </td>
                        ...
                        <div class="container bank-union my-4">
                            ...
                            {{-- <form method="post" action="{{route('feestructure.list')}}">
                                ...
                                <button class="btn btn-link"><p>View fee schedule.</p></button>
                                    </form> --}}
                            ...
                            @if (@$region->Tier2Enabled == 0)
                                <p class="text-center">To register for FlashAlert, <a
                                        href="http://www.flashalertnewswire.net/IIN/index.html?Menu=signup" target="_blank"
                                        rel="noopener noreferrer">start here.</a>
                                </p>
                            @endif
