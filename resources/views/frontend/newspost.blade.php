...
@section('content')
    <style>
        ...
        .cst-drp .dropdown-content a:hover {
            background-color: #ddd;
        }

        .cst-drp.dropdown:hover .dropdown-content {
            display: block;
        }
    </style>
    <section>
    ...
    <section>
        <div id="content">
            <div id="content-core">
                <div id="main">
                    <div id="main-core">
                        <div class="table-responsive iconTbl-mh tbl-large">
                            <table class="table tbl-info-client">
                                <tbody>
                                    <tr>
                                        <td class="loginColor">
                                            @if (Session::has('loginId'))
                                                <p class="mb-0"><strong>Already Logged in</strong>
                                                    <br><span class=""><a class="clk-here-btn"
                                                            href="https://flashalert.projects-codingbrains.com/IIN/dashboard">
                                                            Click
                                            ...
                                            @else
                                                ...
                                                <div class="dropdown">
                                                    <button class="btn dropdown-toggle" type="button" id="loginDropdown"
                                                        data-bs-toggle="dropdown" aria-expanded="false">
                                                        Log In/Create Account
                                                    </button>
                                                    <ul class="dropdown-menu" aria-labelledby="loginDropdown">
                                                        <li><a class="dropdown-item" href="{{ route('backend.signin') }}"><i
                                                                    class="fa fa-right-to-bracket mx-1"></i> Log In</a></li>
                                                        <li><a class="dropdown-item" href="{{ url('IIN/addnewuser') }}"><i
                                                                    class="fa fa-user-plus mx-1"></i> Create Account</a>
                                                        </li>
                                                    </ul>
                                                </div>
                                        ...
                                        <!-- <td id="link-container">
                                            <a href="#" id="open-link">
                                               <i class="fa-regular fa-clipboard fa-2xl"></i>
                                               <br>
                                               <span class="fw-6">View Current Info</span>
                                            </a>
                                         </td> -->
                                         
                                         <!-- <script>
                                            document.getElementById('open-link').addEventListener('click', function() {
                                               window.open('http://www.flashalertportland.net/closures-cats.html', '_blank');
                                            });
                                         </script> -->
                                         <!-- JavaScript for conditional rendering -->
                                        <td><a href="http://forecast.weather.gov/MapClick.php?site=pqr&amp;smap=1&amp;textField1=45.52361&amp;textField2=-122.675#.Una3VCRQ1Ug"
                                                target="_blank" rel="noopener noreferrer"><i
                                                    class="fa-solid fa-cloud-sun fa-2xl"></i></a><br><a class="fw-6"
                                                href="http://forecast.weather.gov/MapClick.php?site=pqr&amp;smap=1&amp;textField1=45.52361&amp;textField2=-122.675#.Una3VCRQ1Ug"
                                                target="_blank" rel="noopener noreferrer">Portland Forecast</a></td>
                                        <td><a href="http://www.tripcheck.com/Pages/RCMap.asp?mainNav=RoadConditions&amp;curRegion=1"
                                                target="_blank" rel="noopener noreferrer"><i
                                                    class="fa-solid fa-road fa-2xl"></i></a><br><a class="fw-6"
                                                href="http://www.tripcheck.com/Pages/RCMap.asp?mainNav=RoadConditions&amp;curRegion=1"
                                                target="_blank" rel="noopener noreferrer">Road Conditions</a>
                                        </td>
                                        <td><a href="{{ asset('tutorial.pdf') }}" target="_blank" rel="noopener"><i
                                                    class="fa-solid fa-chalkboard fa-2xl"></i></a><br><a class="fw-6"
                                                href="{{ asset('tutorial.pdf') }}" target="_blank" rel="noopener">Tutorial
                                                (PDF)</a>
                                        </td>
                                        <td><a href="{{ route('blog') }}"><i class="fa-solid fa-book fa-2xl"></i><br><span
                                                    class="fw-6">Enhancements</span></a>
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
                        <!-- table for tab/mobile start-->
                        <!-- <div class="table-responsive iconTbl-mh tbl-tablet">
                            <table class="table tbl-info-client">
                                <tbody>
                                    <tr>
                                        <td class="loginColor">
                        ...
                        <div class="container bank-union mb-4">
                            ...
                            @if (@$postnews[0]->post_news_region_id == 1)
                                ...
                                <p>Like the basic service, the information you post is placed on media websites. It is
                                    ...
                                    @else
                                        <br>
                                        <strong><a href="{{ url('IIN/addnewuser') }}" target="_blank"
                                                rel="noopener noreferrer">Register here for the <em>premium</em>
                                                service</a>,
                            ...
                            <ol>
                                <li>Your information posts into a page for the media <a href="{{ $postnews[0]->site_url }}"
                                        target="blank"> ({{ $postnews[0]->site_name }}) </a>as soon as it is received. The
                            ...
                            <p>Each organizations has a page with their FlashAlert information. On this page are your
                                ...
                                from your home page. Click&nbsp;<a href="#" target="_blank"
                                    rel="noopener noreferrer">here</a>&nbsp;to see the page for Oregon State Police.</p>
                            ...
                            <p>There is no charge to the public for the Messenger service; the annual cost to an
                                ...
                                Click&nbsp;<a href="{{ route('sampletext') }}" target="_blank"
                                    rel="noopener noreferrer">here</a>&nbsp;for
                            ...
                            <p>Here is a sample report for Portland Police: &nbsp;<a
                                    href="{{ route('monitoring.Report') }}">{{ route('monitoring.Report') }}</a>
                            </p>
                            ...
                            <p>On your account management page, you’ll find a checkbox to activate Media Monitoring.
                                &nbsp;Once you click &nbsp;this,&nbsp;<a
                                    href="http://yournewsinc.net/">YourNewsInc.net</a>&nbsp;will contact you for the
                            ...
                            <form method="post" action="{{ route('participants.list') }}">
                                ...
                                Here’s who is using FlashAlert in Portland:&nbsp;<button class="btn participant">Participant
                                    list </button>
                            </form>
                            <h4><strong>Cost</strong></h4>
                            <p>Click on the link and choose your region to see annual fees for unlimited use
                                (September-August billing cycle, pro-rated after November 1).&nbsp;<a
                                    href="{{ route('feestructure.list', ['id' => $postnews[0]->post_news_region_id]) }}">View
                                    fee schedule.</a></p>
                        ...
                        <button class="btn btn-link">
                            ...
                            <p class="text-center fw-bold"><a
                                    href="https://zohosecurepay.com/checkout/8wkrz69-zhaj5jyg9zd0k/FlashAlert-Newswire"
                            ...
                            <p class="fw-4 text-center">Take FlashAlert for a test drive. Click&nbsp;
                                <a
                                    href="{{ route('flashalert.info', ['id' => $postnews[0]->post_news_region_id]) }}">here</a>&nbsp;for
                                a “dummy” zone.
                            </p>
                            @if (@$region->Tier2Enabled == 0)
                                <p class="text-center">To register for FlashAlert, <a
                                        href="http://www.flashalertnewswire.net/IIN/index.html?Menu=signup"
                        ...
                        <button class="btn btn-link">
                            ...
                            <p style="font-weight: 400; text-align: center;">Click&nbsp;<a
                                    href="https://flashalert.projects-codingbrains.com/policies">here</a>&nbsp;to see
                            ...
                            <div class="barcode-contact d-flex justify-content-around my-3">
                                <div><img decoding="async" class="centerit alignnone img-fluid"
                                        src="{{ asset('front_assets/images/2C4512EF-CD68-4CAE-B776-07B0458402B9-300x287.jpeg') }}"
                                        width="220" height="auto">
                                    <h4>And yes, that is a river of lava 15 feet behind me in Iceland!</h4>
                                </div>
                                <div>
                                    <img decoding="async" class="centerit alignnone img-fluid"
                                        src="{{ asset('front_assets/images/craig-contact.png') }}" width="215"
                                        height="auto">
