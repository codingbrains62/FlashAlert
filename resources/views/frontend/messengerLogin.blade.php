            ...
            <div id="content-core">
                ...
                <div id="main">
                    <div id="main-core">
                        ...
                        <p>Having trouble attaching the FlashAlert app? <a title="Attachment issue" href="{{route('attach-app-tut')}}"
                                target="_blank" rel="noopener">Click here</a>.</p>
                        <p>
                        </p>
                        <p>Support: If you still have trouble, <a href="mailto:flashalert@projects-codingbrains.com">Email support</a>.</p>
                        <p>
                        </p>
